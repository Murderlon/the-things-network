    ...
    return (
      <Layout.ParentGrid as="section">
        ...
        <Layout.SubGrid>
          <Block.Secondary alignLeft centerContent>
            <h4>
              There are three knobs you can turn: transmission power, bandwidth
                ...
                return (
                  <g transform={`translate(${margin.left}, ${margin.top})`}>
                    ...
                    {bandwidths.map((bw, BWIndex) => {
                      ...
                      return sorted.map(
                        ({ spreading_factor, uplinks, downlinks }, SFIndex) => {
                          return (
                            <g
                              onClick={() =>
                                this.handleDataRateClick(BWIndex + 6 - SFIndex)
                              }
                    ...
                    <g
                      transform={`translate(0, ${dimensions.height / 2 + 40})`}
                    >
                      ...
                      >
                        {props => (
                          <rect {...props} height={10} y={10} fill="#b197fc" />
                        )}
                      </Spring>
                    </g>
                  </g>
